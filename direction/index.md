...
| [from-pattern-to-packet.md](from-pattern-to-packet.md) | The complete flow from visual pattern → binary value → semantic identity → rendered icon → 16-bit packet. Traces one glyph through all four representations so readers understand how they relate. Essential for understanding the stability and extensibility of Marain. |
