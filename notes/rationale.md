...
> **First pass on several of these threads:** [`../direction/esperanto-and-hangul.md`](../direction/esperanto-and-hangul.md) examines Esperanto and Hangul as the two most-studied designed languages in modern history, and pulls out adoption-side lessons relevant to marainkit. The short version: political neutrality is not a property a designer can grant; institutional backing or a viable basement-level use case is what determines whether a designed language survives at all. Universalism is partly answerable empirically — Esperanto scored ~75% feature overlap with European languages against a 54% world average, demonstrating that "neutral" designs encode their designer's source-language defaults unless they're actively resisted. Adoption pathways are the area where the contrast is sharpest: Hangul survived 450 years of elite hostility because it was *additive* (could be mixed with Hanja in any ratio) and had a state imprimatur; Esperanto's all-or-nothing proposition combined with no state backing locked it into the network-effects trap.
